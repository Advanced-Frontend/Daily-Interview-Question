...
欢迎在 [Issue](https://github.com/Advanced-Frontend/Daily-Interview-Question/issues/36) 区留下你的答案。
...
解析：[第 29 题：聊聊 Vue 的双向数据绑定，Model 如何改变 View，View 又是如何改变 Model 的?](https://github.com/Advanced-Frontend/Daily-Interview-Question/issues/34)
