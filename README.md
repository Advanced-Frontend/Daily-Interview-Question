...
```
https://www.xx.cn/api?keyword=&level1=&local_batch_id=&local_province_id=33&elective=
https://www.xx.cn/api?keyword=&level1=&local_batch_id=&local_province_id=33&elective=800
https://www.xx.cn/api?keyword=&level1=&local_batch_id=&local_province_id=33&elective=800,700
```

匹配最后的数字输出（写出你认为的最优解法）:
